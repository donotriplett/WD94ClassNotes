...
Write two variables. One will store your name and another will store a friend's name. Find out what property you can use to check 
...
if (myNameLength > friendNameLength) {
    console.log(`${myName}'s name is longer than ${friendName}'s by ${myNameLength - friendNameLength} letter`);
} else if (myNameLength < friendNameLength) {
    console.log(`${friendName}'s name is longer than ${myName}'s by ${friendNameLength - myNameLength} letter`);
} else {
